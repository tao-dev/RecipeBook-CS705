/*
 This class is to handle Biscohito 
...
namespace Amanda_Recipe_Book
{
    class Biscohito
    {
        ...
        public Biscohito()
        {
            FILEPATH.Add(IDD.PATHSIDD.First(p=>p.Contains("3 ing")));//it is getting file path of 3 ing file i.e 3 ingredient.
            // actually PATHSIDD contains all files path so it is getting of specified file name only.
            FILEPATH.Add(IDD.PATHSIDD.First(p => p.Contains("3 ins")));
        }
        #endregion
